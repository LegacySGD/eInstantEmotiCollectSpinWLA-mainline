...
public class EmotiCollectSpinWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(EmotiCollectSpinWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/EmotiCollectSpinWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/EmotiCollectSpinWLAIW/InitOutcome.xml").getDocumentElement();
